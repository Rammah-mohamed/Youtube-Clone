  ...
  return (
    <div className='videoCard'>
      ...
      >
        <div className="image">
          <img 
          src={props.video?.thumbnail[3]?.url 
            && props.video?.thumbnail[2]?.url
            && props.video?.thumbnail[1]?.url 
            && props.video?.thumbnail[0]?.url  === ''? demoThumbnailUrl : 
        ...
        <div className="details">
          <h3 style={{color: props.darkTheme && '#fff'}}>{props.video?.title || demoVideoTitle}</h3>
          <div className="channel">
            <h5 style={{color: props.darkTheme && '#fff'}}>{props.video?.channelTitle || demoChannelTitle}</h5>
